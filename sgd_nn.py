...
def sgd(nn: NN, X_train, X_test, W, C_train, C_test, batch_size, learning_rate, iter_num, divide_lr=50, graph_till_now = None):
    costs = []
    accuracy_train = []
    accuracy_test = []
    m = X_train.shape[1]
...
def sgd_nn_peaks_data():
    ...
    learning_rate = 100
    batch_size = 60
    nn = NN([2, 5, 6, 8, 10, 5], np.tanh, tan_h_gradient)
